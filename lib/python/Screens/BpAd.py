# Embedded file name: /usr/lib/enigma2/python/Screens/BpAd.py
...
class DeliteAddons(Screen):
    ...
    def updateList(self):
        ...
        png = LoadPixmap(mypixmap)
        name = _('Open Donki online update')
        idx = 1
        res = (name, png, idx)
        self.list.append(res)
        mypixmap = mypath + 'icons/nabpackpanel.png'
    ...
    def KeyOk(self):
        ...
        if self.sel == 0:
            ...
            self.session.openWithCallback(self.runUpgrade, MessageBox, _('Do you want to update Open Donki image?') + '\n' + _('\nAfter pressing OK, please wait!'))
        elif self.sel == 2:
            self.checkPanel()
        elif self.sel == 3:
            self.checkPanel2()
...
class Nab_downArea(Screen):
    ...
    def updateList(self):
        ...
        mypixmap = mypath + 'icons/nabplugins.png'
        png = LoadPixmap(mypixmap)
        name = _('Open Donki Feeds Plugins')
        idx = 2
        res = (name, png, idx)
        self.list.append(res)
