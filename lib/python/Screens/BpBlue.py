...
class Nab_DoStartCam(Screen):
	skin = """
	<screen position="390,100" size="484,250" title="Open Donki" flags="wfNoBorder">
...
class BhsysInfo(Screen):
	skin = """
	<screen position="center,center" size="800,600" title="Open Donki Info" flags="wfNoBorder">
...
class BhEpgPanel(Screen):
	skin = """
	<screen position="center,center" size="600,400" title="Open Donki EPG Panel">
